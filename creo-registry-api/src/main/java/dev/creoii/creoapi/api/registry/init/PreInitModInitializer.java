 ...
 *
 * <p>This entrypoint is suitable for setting up logic, systems, or modifications that need to happen <i>before</i> anything in the game is registered. Examples in the Vanilla game include:</p>
 * <ul>
 *     <li>Flammable Blocks</li>
 *     <li>Compostable Items</li>
 *     <li>Dispenser Behaviors</li>
 *     <li>Cauldron Behaviors</li>
 * </ul>
 *
