...
public final class StatusEffectTagImpl {
    ...
    public static boolean applyCuresZombieVillagers(RegistryEntry<StatusEffect> registryEntry) {
        return registryEntry.isIn(CreoStatusEffectTags.CURES_ZOMBIE_VILLAGERS);
    }
}
