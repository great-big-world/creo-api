...
public record FastNoiseMaterialCondition(RegistryEntry<FastNoiseParameters> noise, double minThreshold, double maxThreshold) implements MaterialRules.MaterialCondition {
