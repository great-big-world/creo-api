...
public record PoolFeatureConfig(int yOffset, IntProvider rimSize, BlockStateProvider rimState, BlockStateProvider innerState, IntProvider height, IntProvider startRadius, IntProvider innerDepth, TagKey<Block> replaceable, boolean solidRim) implements FeatureConfig {
